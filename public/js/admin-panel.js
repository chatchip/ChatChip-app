...
async function loadBusinessOverview() {
    ...
    try {
        ...
        container.innerHTML = `
            ...
            <div style="display:grid;grid-template-columns:${mobile ? 'repeat(2,minmax(0,1fr))' : 'repeat(auto-fit,minmax(105px,1fr))'};gap:7px;margin-bottom:12px;min-width:0;">${cards}</div>
            <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;overflow-x:auto;max-width:100%;width:100%;-webkit-overflow-scrolling:touch;">
              <table style="width:100%;border-collapse:collapse;font-size:${mobile?'10px':'12px'};min-width:${mobile?'760px':'1000px'};margin:0;">
