...
const urlsToCache = [
  ...
  '/js/crypto.js','/js/datamanager.js','/js/sidebar.js?v=20260922-hotfix3','/js/puzzleSwipeLoader.js?v=20260922-hotfix2','/js/integrations.js?v=20260922-hotfix2','/js/imageServices.js?v=20260922-hotfix4','/js/app.js?v=20260922-hotfix4','/js/backoffice.js','/js/admin-panel.js','/js/pricing.js','/js/tree-detail.js','/js/cuzdan.js',
