...
const urlsToCache = [
  ...
  '/js/crypto.js','/js/datamanager.js','/js/sidebar.js','/js/imageServices.js','/js/imageUpload.js','/js/app.js','/js/auth.js','/js/ui.js','/js/sessions.js','/js/voice.js','/js/admin-panel.js','/js/pricing.js',
