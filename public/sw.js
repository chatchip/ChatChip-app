...
const urlsToCache = [
  ...
  '/js/crypto.js','/js/datamanager.js','/js/sidebar.js','/js/imageServices.js','/js/biometric.js','/js/imageUpload.js','/js/app.js','/js/backoffice.js','/js/admin-panel.js','/js/pricing.js','/js/tree-detail.js','/js/cuzdan.js',
